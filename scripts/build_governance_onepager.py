...
STATIONS = [
    (BLUE, ("unitycatalog",), None, "01", "enters", "What data?",
     ...
     "Two documents per feed — the FRD and the vendor data dictionary — land in Unity Catalog, "
     "where every folder and table carries an owner, a steward, its sensitivity, its source and "
     "its retention rule. The standards are config in the agent, not a document.",
